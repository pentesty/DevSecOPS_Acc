...
//       	}
    ...
    stage ('Dynamic analysis') {
		...
		sh 'ssh -o  StrictHostKeyChecking=no ubuntu@13.233.123.52 "sudo docker run --rm -v /home/ubuntu:/zap/wrk/:rw -t owasp/zap2docker-stable zap-full-scan.py -t http://10.0.2.15:8080/WebGoat -x zap_report -n defaultcontext.context || true" '
